package leetcode.动态规划.俄罗斯套娃信封问题;
...
public class Solution {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner scanner = new Scanner(new FileInputStream("E:\\Everett\\OneDrive - std.uestc.edu.cn\\Data\\leecode\\LeecodeSolutions\\src\\main\\java\\leetcode.俄罗斯套娃信封问题\\input.txt"));
        for (int i = 0; i < 14; i++) {
