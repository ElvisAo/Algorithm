package leetcode.动态规划.打家劫舍系列.Ⅲ;
...
public class Solution {
    ...
    public int solution_1(TreeNode root) {
        ...
        int do_it = root.val
                + (root.left == null ? 0 : solution_1(root.left.left) + solution_1(root.left.right))
                + (root.right == null ? 0 : solution_1(root.right.left) + solution_1(root.right.right));
